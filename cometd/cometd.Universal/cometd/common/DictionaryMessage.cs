    ...
    public class DictionaryMessage : Dictionary<String, Object>, IMutableMessage
    {
        ...
        public IDictionary<String, Object> Advice
        {
            get
            {
                ...
                if (advice != null)
                {
                    return JsonConvert.DeserializeObject<Dictionary<String, Object>>(advice.ToString());
                }
        ...
        public IDictionary<String, Object> Ext
        {
            get
            {
                ...
                if (ext != null)
                {
                    return JsonConvert.DeserializeObject<Dictionary<String, Object>>(ext.ToString());
                }
                return new Dictionary<string, object>();
            }
        }
        ...
        {
            IList<Dictionary<String, Object>> dictionaryList = null;
            try
            {
                dictionaryList = JsonConvert.DeserializeObject<List<Dictionary<String, Object>>>(content);
            }
            catch (Exception e)
            {
                Debug.WriteLine("Exception when parsing json {0}", e);
            }
